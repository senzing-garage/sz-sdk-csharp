...
internal class SzRecord
{
    internal interface SzRecordData
    {
    ...
    internal sealed record SzDataSourceCode(string DataSourceCode) : SzRecordData
    {
    ...
    internal sealed record SzRecordID(string RecordID) : SzRecordData
    {
    ...
    internal sealed record SzRecordType(string RecordType) : SzRecordData
    {
    ...
    internal interface SzName : SzRecordData
    {
    ...
    internal interface SzAddress : SzRecordData
    {
    ...
    internal sealed record SzFullName(string FullName, string? NameType) : SzName
    {
    ...
    internal sealed record SzNameByParts(
    ...
    internal sealed record SzFullAddress(string FullAddress, string? AddressType) : SzAddress
    {
    ...
    internal sealed record SzAddressByParts(
    ...
    internal sealed record SzPhoneNumber(string Phone, string? PhoneType) : SzRecordData
    {
    ...
    internal sealed record SzEmailAddress(string Email, string? EmailType) : SzRecordData
    {
        public string GetPluralName()
        {
            return "EMAILS";
    ...
    internal sealed record SzDateOfBirth(string Date) : SzRecordData
    {
    ...
    internal sealed record SzSocialSecurity(string Ssn) : SzRecordData
    {
    ...
    internal sealed record SzDriversLicense(string LicenseNumber, string? State)
        : SzRecordData
    {
    ...
    internal sealed record SzPassport(string PassportNumber, string? Country)
        : SzRecordData
    {
    ...
    private readonly IDictionary<object, List<SzRecordData>> dataMap;
    private readonly List<object> dataTypeList;
